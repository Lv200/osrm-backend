...
extern DuplicatedNodesDefaultTypeInternal _DuplicatedNodes_default_instance_;
class EdgeBasedNode;
...
namespace google {
namespace protobuf {
template<> ::pbebg::DuplicatedNodes* Arena::CreateMaybeMessage<::pbebg::DuplicatedNodes>(Arena*);
...
class TurnPenalties final :
 ...
 public:
  ...
  int turn_durations_size() const;
  void clear_turn_durations();
  static const int kTurnDurationsFieldNumber = 2;
  ::google::protobuf::uint32 turn_durations(int index) const;
  void set_turn_durations(int index, ::google::protobuf::uint32 value);
  void add_turn_durations(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      turn_durations() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_turn_durations();
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > turn_durations_;
  mutable std::atomic<int> _turn_durations_cached_byte_size_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_edge_2dbased_2dgraph_2eproto;
};
// -------------------------------------------------------------------

class DuplicatedNodes final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pbebg.DuplicatedNodes) */ {
 public:
  DuplicatedNodes();
  virtual ~DuplicatedNodes();

  DuplicatedNodes(const DuplicatedNodes& from);

  inline DuplicatedNodes& operator=(const DuplicatedNodes& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  DuplicatedNodes(DuplicatedNodes&& from) noexcept
    : DuplicatedNodes() {
    *this = ::std::move(from);
  }

  inline DuplicatedNodes& operator=(DuplicatedNodes&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DuplicatedNodes& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DuplicatedNodes* internal_default_instance() {
    return reinterpret_cast<const DuplicatedNodes*>(
               &_DuplicatedNodes_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  void Swap(DuplicatedNodes* other);
  friend void swap(DuplicatedNodes& a, DuplicatedNodes& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline DuplicatedNodes* New() const final {
    return CreateMaybeMessage<DuplicatedNodes>(nullptr);
  }

  DuplicatedNodes* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<DuplicatedNodes>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const DuplicatedNodes& from);
  void MergeFrom(const DuplicatedNodes& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DuplicatedNodes* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return nullptr;
  }
  ...
  ::google::protobuf::uint32 origin(int index) const;
  void set_origin(int index, ::google::protobuf::uint32 value);
  void add_origin(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      origin() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_origin();
  ...
  int duplicated_size() const;
  void clear_duplicated();
  static const int kDuplicatedFieldNumber = 2;
  ::google::protobuf::uint32 duplicated(int index) const;
  void set_duplicated(int index, ::google::protobuf::uint32 value);
  void add_duplicated(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      duplicated() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_duplicated();

  // @@protoc_insertion_point(class_scope:pbebg.DuplicatedNodes)
 private:
  class HasBitSetters;

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > origin_;
  mutable std::atomic<int> _origin_cached_byte_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > duplicated_;
  mutable std::atomic<int> _duplicated_cached_byte_size_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_edge_2dbased_2dgraph_2eproto;
};
// ===================================================================
...
// repeated uint32 turn_durations = 2;
inline int TurnPenalties::turn_durations_size() const {
  return turn_durations_.size();
}
inline void TurnPenalties::clear_turn_durations() {
  turn_durations_.Clear();
}
inline ::google::protobuf::uint32 TurnPenalties::turn_durations(int index) const {
  // @@protoc_insertion_point(field_get:pbebg.TurnPenalties.turn_durations)
  return turn_durations_.Get(index);
}
inline void TurnPenalties::set_turn_durations(int index, ::google::protobuf::uint32 value) {
  turn_durations_.Set(index, value);
  // @@protoc_insertion_point(field_set:pbebg.TurnPenalties.turn_durations)
}
inline void TurnPenalties::add_turn_durations(::google::protobuf::uint32 value) {
  turn_durations_.Add(value);
  // @@protoc_insertion_point(field_add:pbebg.TurnPenalties.turn_durations)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
TurnPenalties::turn_durations() const {
  // @@protoc_insertion_point(field_list:pbebg.TurnPenalties.turn_durations)
  return turn_durations_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
TurnPenalties::mutable_turn_durations() {
  // @@protoc_insertion_point(field_mutable_list:pbebg.TurnPenalties.turn_durations)
  return &turn_durations_;
}
...
// repeated uint32 origin = 1;
inline int DuplicatedNodes::origin_size() const {
  return origin_.size();
}
inline void DuplicatedNodes::clear_origin() {
  origin_.Clear();
}
inline ::google::protobuf::uint32 DuplicatedNodes::origin(int index) const {
  // @@protoc_insertion_point(field_get:pbebg.DuplicatedNodes.origin)
  return origin_.Get(index);
}
inline void DuplicatedNodes::set_origin(int index, ::google::protobuf::uint32 value) {
  origin_.Set(index, value);
  // @@protoc_insertion_point(field_set:pbebg.DuplicatedNodes.origin)
}
inline void DuplicatedNodes::add_origin(::google::protobuf::uint32 value) {
  origin_.Add(value);
  // @@protoc_insertion_point(field_add:pbebg.DuplicatedNodes.origin)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
DuplicatedNodes::origin() const {
  // @@protoc_insertion_point(field_list:pbebg.DuplicatedNodes.origin)
  return origin_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
DuplicatedNodes::mutable_origin() {
  // @@protoc_insertion_point(field_mutable_list:pbebg.DuplicatedNodes.origin)
  return &origin_;
}

// repeated uint32 duplicated = 2;
inline int DuplicatedNodes::duplicated_size() const {
  return duplicated_.size();
}
inline void DuplicatedNodes::clear_duplicated() {
  duplicated_.Clear();
}
inline ::google::protobuf::uint32 DuplicatedNodes::duplicated(int index) const {
  // @@protoc_insertion_point(field_get:pbebg.DuplicatedNodes.duplicated)
  return duplicated_.Get(index);
}
inline void DuplicatedNodes::set_duplicated(int index, ::google::protobuf::uint32 value) {
  duplicated_.Set(index, value);
  // @@protoc_insertion_point(field_set:pbebg.DuplicatedNodes.duplicated)
}
inline void DuplicatedNodes::add_duplicated(::google::protobuf::uint32 value) {
  duplicated_.Add(value);
  // @@protoc_insertion_point(field_add:pbebg.DuplicatedNodes.duplicated)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
DuplicatedNodes::duplicated() const {
  // @@protoc_insertion_point(field_list:pbebg.DuplicatedNodes.duplicated)
  return duplicated_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
DuplicatedNodes::mutable_duplicated() {
  // @@protoc_insertion_point(field_mutable_list:pbebg.DuplicatedNodes.duplicated)
  return &duplicated_;
}
