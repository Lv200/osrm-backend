...
inline ::google::protobuf::int32 Metric::durations(int index) const {
  // @@protoc_insertion_point(field_get:pbmld.Metric.durations)
  return durations_.Get(index);
}
inline void Metric::set_durations(int index, ::google::protobuf::int32 value) {
  durations_.Set(index, value);
  // @@protoc_insertion_point(field_set:pbmld.Metric.durations)
}
inline void Metric::add_durations(::google::protobuf::int32 value) {
