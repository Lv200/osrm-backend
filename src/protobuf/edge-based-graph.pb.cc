...
class DuplicatedNodesDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<DuplicatedNodes> _instance;
} _DuplicatedNodes_default_instance_;
}  // namespace pbebg
...
static void InitDefaultsDuplicatedNodes_edge_2dbased_2dgraph_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::pbebg::_DuplicatedNodes_default_instance_;
    new (ptr) ::pbebg::DuplicatedNodes();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::pbebg::DuplicatedNodes::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_DuplicatedNodes_edge_2dbased_2dgraph_2eproto =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsDuplicatedNodes_edge_2dbased_2dgraph_2eproto}, {}};
...
void InitDefaults_edge_2dbased_2dgraph_2eproto() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_DuplicatedNodes_edge_2dbased_2dgraph_2eproto.base);
}

::google::protobuf::Metadata file_level_metadata_edge_2dbased_2dgraph_2eproto[6];
...
const ::google::protobuf::uint32 TableStruct_edge_2dbased_2dgraph_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::pbebg::TurnPenalties, turn_durations_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pbebg::DuplicatedNodes, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::pbebg::DuplicatedNodes, origin_),
  PROTOBUF_FIELD_OFFSET(::pbebg::DuplicatedNodes, duplicated_),
};
static const ::google::protobuf::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 36, -1, sizeof(::pbebg::DuplicatedNodes)},
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::pbebg::_DuplicatedNodes_default_instance_),
};
...
::google::protobuf::internal::AssignDescriptorsTable assign_descriptors_table_edge_2dbased_2dgraph_2eproto = {
  ...
  file_level_metadata_edge_2dbased_2dgraph_2eproto, 6, file_level_enum_descriptors_edge_2dbased_2dgraph_2eproto, file_level_service_descriptors_edge_2dbased_2dgraph_2eproto,
};
...
const char descriptor_table_protodef_edge_2dbased_2dgraph_2eproto[] =
  ...
  "nPenalties\022\026\n\016turn_penalties\030\001 \003(\r\022\026\n\016tu"
  "rn_durations\030\002 \003(\r\"5\n\017DuplicatedNodes\022\016\n"
  "\006origin\030\001 \003(\r\022\022\n\nduplicated\030\002 \003(\rb\006proto"
  "3"
  ;
::google::protobuf::internal::DescriptorTable descriptor_table_edge_2dbased_2dgraph_2eproto = {
  ...
  "edge-based-graph.proto", &assign_descriptors_table_edge_2dbased_2dgraph_2eproto, 481,
};
...
const int TurnPenalties::kTurnDurationsFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
TurnPenalties::TurnPenalties(const TurnPenalties& from)
  : ::google::protobuf::Message(),
      ...
      turn_durations_(from.turn_durations_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
...
const char* TurnPenalties::_InternalParse(const char* begin, const char* end, void* object,
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      // repeated uint32 turn_durations = 2;
      case 2: {
        if (static_cast<::google::protobuf::uint8>(tag) == 18) {
          ptr = ::google::protobuf::io::ReadSize(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          parser_till_end = ::google::protobuf::internal::PackedUInt32Parser;
          object = msg->mutable_turn_durations();
          if (size > end - ptr) goto len_delim_till_end;
          auto newend = ptr + size;
          if (size) ptr = parser_till_end(ptr, newend, object, ctx);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr == newend);
        ...
        do {
          msg->add_turn_durations(::google::protobuf::internal::ReadVarint(&ptr));
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          if (ptr >= end) break;
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (18 & 0xFF)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, this->mutable_turn_durations())));
        } else if (static_cast< ::google::protobuf::uint8>(tag) == (16 & 0xFF)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 18u, input, this->mutable_turn_durations())));
        } else {
          goto handle_unusual;
        }
        break;
...
void TurnPenalties::SerializeWithCachedSizes(
  ...
  // repeated uint32 turn_durations = 2;
  if (this->turn_durations_size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteTag(2, ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED, output);
    output->WriteVarint32(_turn_durations_cached_byte_size_.load(
        std::memory_order_relaxed));
  }
  for (int i = 0, n = this->turn_durations_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32NoTag(
      this->turn_durations(i), output);
  }
...
::google::protobuf::uint8* TurnPenalties::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->turn_durations_size() > 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteTagToArray(
      ...
      target);
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _turn_durations_cached_byte_size_.load(std::memory_order_relaxed),
         target);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32NoTagToArray(this->turn_durations_, target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:pbebg.TurnPenalties)
  ...
  {
    size_t data_size = ::google::protobuf::internal::WireFormatLite::
      UInt32Size(this->turn_durations_);
    if (data_size > 0) {
      total_size += 1 +
        ::google::protobuf::internal::WireFormatLite::Int32Size(
            static_cast<::google::protobuf::int32>(data_size));
    ...
    int cached_size = ::google::protobuf::internal::ToCachedSize(data_size);
    _turn_durations_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:pbebg.TurnPenalties)
  ...
  turn_durations_.MergeFrom(from.turn_durations_);
}
...
void TurnPenalties::InternalSwap(TurnPenalties* other) {
  ...
  turn_durations_.InternalSwap(&other->turn_durations_);
}
...
void DuplicatedNodes::InitAsDefaultInstance() {
}
class DuplicatedNodes::HasBitSetters {
 public:
};

#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int DuplicatedNodes::kOriginFieldNumber;
const int DuplicatedNodes::kDuplicatedFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

DuplicatedNodes::DuplicatedNodes()
  : ::google::protobuf::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:pbebg.DuplicatedNodes)
}
DuplicatedNodes::DuplicatedNodes(const DuplicatedNodes& from)
  : ::google::protobuf::Message(),
      _internal_metadata_(nullptr),
      origin_(from.origin_),
      duplicated_(from.duplicated_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:pbebg.DuplicatedNodes)
}

void DuplicatedNodes::SharedCtor() {
}

DuplicatedNodes::~DuplicatedNodes() {
  // @@protoc_insertion_point(destructor:pbebg.DuplicatedNodes)
  SharedDtor();
}

void DuplicatedNodes::SharedDtor() {
}

void DuplicatedNodes::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const DuplicatedNodes& DuplicatedNodes::default_instance() {
  ::google::protobuf::internal::InitSCC(&::scc_info_DuplicatedNodes_edge_2dbased_2dgraph_2eproto.base);
  return *internal_default_instance();
}


void DuplicatedNodes::Clear() {
// @@protoc_insertion_point(message_clear_start:pbebg.DuplicatedNodes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* DuplicatedNodes::_InternalParse(const char* begin, const char* end, void* object,
                  ::google::protobuf::internal::ParseContext* ctx) {
  auto msg = static_cast<DuplicatedNodes*>(object);
  ::google::protobuf::int32 size; (void)size;
  int depth; (void)depth;
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::ParseFunc parser_till_end; (void)parser_till_end;
  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        do {
          msg->add_origin(::google::protobuf::internal::ReadVarint(&ptr));
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          if (ptr >= end) break;
        } while ((::google::protobuf::io::UnalignedLoad<::google::protobuf::uint64>(ptr) & 255) == 8 && (ptr += 1));
        break;
      ...
      case 2: {
        ...
        do {
          msg->add_duplicated(::google::protobuf::internal::ReadVarint(&ptr));
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          if (ptr >= end) break;
        } while ((::google::protobuf::io::UnalignedLoad<::google::protobuf::uint64>(ptr) & 255) == 16 && (ptr += 1));
        break;
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool DuplicatedNodes::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:pbebg.DuplicatedNodes)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (18 & 0xFF)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, this->mutable_duplicated())));
        } else if (static_cast< ::google::protobuf::uint8>(tag) == (16 & 0xFF)) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 18u, input, this->mutable_duplicated())));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:pbebg.DuplicatedNodes)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:pbebg.DuplicatedNodes)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void DuplicatedNodes::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:pbebg.DuplicatedNodes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (int i = 0, n = this->origin_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32NoTag(
      this->origin(i), output);
  }

  // repeated uint32 duplicated = 2;
  if (this->duplicated_size() > 0) {
    ::google::protobuf::internal::WireFormatLite::WriteTag(2, ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED, output);
    output->WriteVarint32(_duplicated_cached_byte_size_.load(
        std::memory_order_relaxed));
  }
  for (int i = 0, n = this->duplicated_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32NoTag(
      this->duplicated(i), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:pbebg.DuplicatedNodes)
}

::google::protobuf::uint8* DuplicatedNodes::InternalSerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:pbebg.DuplicatedNodes)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->origin_size() > 0) {
    ...
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _origin_cached_byte_size_.load(std::memory_order_relaxed),
         target);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32NoTagToArray(this->origin_, target);
  }
  ...
  if (this->duplicated_size() > 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteTagToArray(
      ...
      target);
    target = ::google::protobuf::io::CodedOutputStream::WriteVarint32ToArray(
        _duplicated_cached_byte_size_.load(std::memory_order_relaxed),
         target);
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32NoTagToArray(this->duplicated_, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:pbebg.DuplicatedNodes)
  return target;
}

size_t DuplicatedNodes::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:pbebg.DuplicatedNodes)
  size_t total_size = 0;
  ...
  // repeated uint32 duplicated = 2;
  {
    ...
    int cached_size = ::google::protobuf::internal::ToCachedSize(data_size);
    _duplicated_cached_byte_size_.store(cached_size,
                                    std::memory_order_relaxed);
    total_size += data_size;
  }
...
void DuplicatedNodes::MergeFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:pbebg.DuplicatedNodes)
  GOOGLE_DCHECK_NE(&from, this);
  const DuplicatedNodes* source =
      ::google::protobuf::DynamicCastToGenerated<DuplicatedNodes>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:pbebg.DuplicatedNodes)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:pbebg.DuplicatedNodes)
    MergeFrom(*source);
  }
}

void DuplicatedNodes::MergeFrom(const DuplicatedNodes& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:pbebg.DuplicatedNodes)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  duplicated_.MergeFrom(from.duplicated_);
}

void DuplicatedNodes::CopyFrom(const ::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:pbebg.DuplicatedNodes)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void DuplicatedNodes::CopyFrom(const DuplicatedNodes& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:pbebg.DuplicatedNodes)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DuplicatedNodes::IsInitialized() const {
  return true;
}

void DuplicatedNodes::Swap(DuplicatedNodes* other) {
  if (other == this) return;
  InternalSwap(other);
}
void DuplicatedNodes::InternalSwap(DuplicatedNodes* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  origin_.InternalSwap(&other->origin_);
  duplicated_.InternalSwap(&other->duplicated_);
}

::google::protobuf::Metadata DuplicatedNodes::GetMetadata() const {
  ::google::protobuf::internal::AssignDescriptors(&::assign_descriptors_table_edge_2dbased_2dgraph_2eproto);
  return ::file_level_metadata_edge_2dbased_2dgraph_2eproto[kIndexInFileMessages];
}
...
template<> PROTOBUF_NOINLINE ::pbebg::DuplicatedNodes* Arena::CreateMaybeMessage< ::pbebg::DuplicatedNodes >(Arena* arena) {
  return Arena::CreateInternal< ::pbebg::DuplicatedNodes >(arena);
}
}  // namespace protobuf
}  // namespace google
